...
if (safariVersion < DEFAULT_VERSION) {
    ...
    window.jQuery || document.write('<script type="text/javascript" src="' + EXTEND_PATH + 'libs/jquery-3.5.1.min.js"><\/script>');
    window.jQuery || document.write('<script type="text/javascript" src="' + EXTEND_PATH + 'libs/jquery-migrate-3.1.0.min.js"><\/script>');
}
